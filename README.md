...
- [The AI Buildout Is So Big That Rivals Now Share the Same Supercomputer](https://youtu.be/Sw2rznJ50bw)
- [OpenAI's AI Just Disproved Paul Erdős's 80-Year-Old Math Conjecture](https://youtu.be/RhH_dtyic_A)
- [3,800 GitHub Internal Repos Just Got Breached. Via One VS Code Extension.](https://youtu.be/2UPc1-ytkjg)
