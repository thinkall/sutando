...
- [Sutando WIRE · ep. 007 — 50 days. 600+ PRs. #1 trending dev.](https://youtu.be/nET6ImJRuKk)
- [AI That Runs a Real Sales Demo. Not in Theory. In Odoo.](https://youtu.be/zWBH4UeQeZQ)
- [Three labs, three directions — Sutando WIRE ep. 005](https://youtu.be/QKzdXNkuL80)
- [Codex vs Claude Code. Same /goal. One Shipped Theater.](https://youtu.be/Ufir0qjiYqE)
